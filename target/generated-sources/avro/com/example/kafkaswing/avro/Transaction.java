...
public class Transaction extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8143981703683924019L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Transaction\",\"namespace\":\"com.example.kafkaswing.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"double\"}]}");
   ...
   */
  public static com.example.kafkaswing.avro.Transaction.Builder newBuilder() {
    return new com.example.kafkaswing.avro.Transaction.Builder();
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.example.kafkaswing.avro.Transaction.Builder newBuilder(com.example.kafkaswing.avro.Transaction.Builder other) {
    if (other == null) {
      return new com.example.kafkaswing.avro.Transaction.Builder();
    } else {
      return new com.example.kafkaswing.avro.Transaction.Builder(other);
    }
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.example.kafkaswing.avro.Transaction.Builder newBuilder(com.example.kafkaswing.avro.Transaction other) {
    if (other == null) {
      return new com.example.kafkaswing.avro.Transaction.Builder();
    } else {
      return new com.example.kafkaswing.avro.Transaction.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Transaction>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafkaswing.avro.Transaction.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafkaswing.avro.Transaction other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaswing.avro.Transaction.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaswing.avro.Transaction.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaswing.avro.Transaction.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafkaswing.avro.Transaction.Builder clearAmount() {
